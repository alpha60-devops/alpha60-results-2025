...
### <a href="https://raw.githubusercontent.com/alpha60-devops/alpha60-results-2025/refs/heads/main/data/geojson.cumulative/tron-ares-cumulative-aggregate.geojson.gz" data-map-title="Tron Ares — tron-ares" onclick="leaflet_map_open_window(this.href, this.dataset.mapTitle); return false;" class="table-link" aria-label="Open Tron Ares (tron-ares) cumulative data map in new window" title="Opens interactive map for Tron Ares (tron-ares) data">Swarm Detail</a>
