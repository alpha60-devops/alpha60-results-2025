...
### <a href="https://raw.githubusercontent.com/alpha60-devops/alpha60-results-2025/refs/heads/main/data/geojson.cumulative/peacemaker-201-cumulative-aggregate.geojson.gz" data-map-title="Peacemaker — peacemaker-201" onclick="leaflet_map_open_window(this.href, this.dataset.mapTitle); return false;" class="table-link" aria-label="Open Peacemaker (peacemaker-201) cumulative data map in new window" title="Opens interactive map for Peacemaker (peacemaker-201) data">Swarm Detail</a>
