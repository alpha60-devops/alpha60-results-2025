...
### <a href="https://raw.githubusercontent.com/alpha60-devops/alpha60-results-2025/refs/heads/main/data/geojson.cumulative/lazarus-111-cumulative-aggregate.geojson.gz" data-map-title="Lazarus — lazarus-111" onclick="leaflet_map_open_window(this.href, this.dataset.mapTitle); return false;" class="table-link" aria-label="Open Lazarus (lazarus-111) cumulative data map in new window" title="Opens interactive map for Lazarus (lazarus-111) data">Swarm Detail</a>
