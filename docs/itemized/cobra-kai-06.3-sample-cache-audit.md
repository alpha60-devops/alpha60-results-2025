...
### <a href="https://raw.githubusercontent.com/alpha60-devops/alpha60-results-2025/refs/heads/main/data/geojson.cumulative/cobra-kai-06.3-cumulative-aggregate.geojson.gz" data-map-title="Cobra Kai — cobra-kai-06.3" onclick="leaflet_map_open_window(this.href, this.dataset.mapTitle); return false;" class="table-link" aria-label="Open Cobra Kai (cobra-kai-06.3) cumulative data map in new window" title="Opens interactive map for Cobra Kai (cobra-kai-06.3) data">Swarm Detail</a>
