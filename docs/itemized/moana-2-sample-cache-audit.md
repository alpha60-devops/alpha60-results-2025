...
### <a href="https://raw.githubusercontent.com/alpha60-devops/alpha60-results-2025/refs/heads/main/data/geojson.cumulative/moana-2-cumulative-aggregate.geojson.gz" data-map-title="Moana 2 — moana-2" onclick="leaflet_map_open_window(this.href, this.dataset.mapTitle); return false;" class="table-link" aria-label="Open Moana 2 (moana-2) cumulative data map in new window" title="Opens interactive map for Moana 2 (moana-2) data">Swarm Detail</a>
