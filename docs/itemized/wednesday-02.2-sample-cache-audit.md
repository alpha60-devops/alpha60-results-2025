...
### <a href="https://raw.githubusercontent.com/alpha60-devops/alpha60-results-2025/refs/heads/main/data/geojson.cumulative/wednesday-02.2-cumulative-aggregate.geojson.gz" data-map-title="Wednesday — wednesday-02.2" onclick="leaflet_map_open_window(this.href, this.dataset.mapTitle); return false;" class="table-link" aria-label="Open Wednesday (wednesday-02.2) cumulative data map in new window" title="Opens interactive map for Wednesday (wednesday-02.2) data">Swarm Detail</a>
