...
### <a href="https://raw.githubusercontent.com/alpha60-devops/alpha60-results-2025/refs/heads/main/data/geojson.cumulative/squid-game-03-cumulative-aggregate.geojson.gz" data-map-title="Squid Game — squid-game-03" onclick="leaflet_map_open_window(this.href, this.dataset.mapTitle); return false;" class="table-link" aria-label="Open Squid Game (squid-game-03) cumulative data map in new window" title="Opens interactive map for Squid Game (squid-game-03) data">Swarm Detail</a>
