...
### <a href="https://raw.githubusercontent.com/alpha60-devops/alpha60-results-2025/refs/heads/main/data/geojson.cumulative/reacher-301-cumulative-aggregate.geojson.gz" data-map-title="Reacher — reacher-301" onclick="leaflet_map_open_window(this.href, this.dataset.mapTitle); return false;" class="table-link" aria-label="Open Reacher (reacher-301) cumulative data map in new window" title="Opens interactive map for Reacher (reacher-301) data">Swarm Detail</a>
