...
### <a href="https://raw.githubusercontent.com/alpha60-devops/alpha60-results-2025/refs/heads/main/data/geojson.cumulative/ironheart-01-cumulative-aggregate.geojson.gz" data-map-title="Ironheart — ironheart-01" onclick="leaflet_map_open_window(this.href, this.dataset.mapTitle); return false;" class="table-link" aria-label="Open Ironheart (ironheart-01) cumulative data map in new window" title="Opens interactive map for Ironheart (ironheart-01) data">Swarm Detail</a>
